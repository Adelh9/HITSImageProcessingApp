...
import com.example.prototype.databinding.ActivityImageSelectionBinding
import com.example.prototype.imageEditing.ImageEditingActivity

class ImageSelectionActivity : AppCompatActivity() {
    //bind kt class to xml view
    private val binding by viewBinding(
        ActivityImageSelectionBinding::bind,
        R.id.imageSelectionLayout
    )
